...
$destination_folder		= '../upload/images/'; //upload directory ends with / (slash)
...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	if($image_res){
		...
		$new_file_name = $_POST['imageName']."." . $image_extension;
		
		//folder path to save resized images and thumbnails
		$image_save_folder 	= $destination_folder . $thumb_prefix . $new_file_name; 
