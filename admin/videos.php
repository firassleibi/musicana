...
<?php
	...
	$query=mysqli_query($con,"select * from videos where singer_id='$sid'");
	while($row=mysqli_fetch_assoc($query)){
		$l[]=$row;
	}
	$json=json_encode($l);
	file_put_contents("json/videos.json",$json);
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">قائمة الفيديو</h4>
                            </div>
                            <div class="content">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                	...
                                	<input name="submit" type="submit" class="btn btn-info" value="إضافة فيديو"/>
                                   
                                    </div>
                                </div>
                            </form>
                                <table id="table" class="table table-striped table-bordered table-hover" data-toggle="table" data-url="json/videos.json"  data-cache="false" data-pagination="true" data-search="true">
							<thead>
                            
							<tr>             
                            	<th data-align="center" data-valign="middle" data-field="video" data-formatter="urlOperator">
									 رابط الفيديو
								</th> 
