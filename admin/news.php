...
<?php
	...
	$json=json_encode($l);
	file_put_contents("json/news.json",$json);
...
<div class="wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <table id="table" class="table table-striped table-bordered table-hover" data-toggle="table" data-url="json/news.json"  data-cache="false" data-pagination="true" data-search="true">
							<thead>
    ...
    <script>
		...
		'click .ban': function (e, value, row, index) {
				window.location="updatenews.php?id="+row['id'];
        }
    };
	</script>
